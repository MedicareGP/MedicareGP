...
class PatientViewImmunizations extends StatefulWidget {
  PatientViewImmunizations({
    super.key,
  });

  @override
  // Creating the state for this widget.
  State<PatientViewImmunizations> createState() =>
      _PatientViewImmunizationsState();
}

// Private State class for handling the dynamic aspects of the PatientViewImmunizations screen.
class _PatientViewImmunizationsState extends State<PatientViewImmunizations> {
