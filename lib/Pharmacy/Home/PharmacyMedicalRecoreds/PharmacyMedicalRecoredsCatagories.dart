...
import 'package:medicare/Pharmacy/Home/PharmacyMedicalRecoreds/Test/viewTests.dart';
import 'package:medicare/Pharmacy/Home/PharmacyMedicalRecoreds/allergies/ViewAllergies.dart';
import 'package:medicare/Pharmacy/Home/PharmacyMedicalRecoreds/immunizations/ViewImmunizations.dart';
import 'package:medicare/Pharmacy/Home/PharmacyMedicalRecoreds/physicalExamination/ViewPhysicalExamination.dart';
import 'package:medicare/Pharmacy/Home/PharmacyMedicalRecoreds/procedures/ViewProcedures.dart';

// Defining a StatefulWidget to handle state changes for the PharmacyMedicalRecoredsCatagories.
class PharmacyMedicalRecoredsCatagories extends StatefulWidget {
  ...
  State<PharmacyMedicalRecoredsCatagories> createState() =>
      _PharmacyMedicalRecoredsCatagoriesState();
}

// Private State class for handling the dynamic aspects of the PharmacyMedicalRecoredsCatagories.
class _PharmacyMedicalRecoredsCatagoriesState
    extends State<PharmacyMedicalRecoredsCatagories> {
  @override
                ...
                GestureDetector(
                  onTap: () {
                    Route route = MaterialPageRoute(
                        builder: (_) => AllAlternativePrescribedMedications(
