...
class updateMedicalRecreds extends StatefulWidget {
  @override
  // Creating the state for this widget.
  State<updateMedicalRecreds> createState() => _updateMedicalRecredsState();
}

// Private State class for handling the dynamic aspects of the updateMedicalRecreds screen.
class _updateMedicalRecredsState extends State<updateMedicalRecreds> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, "Alternative Medication",
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Date',
                            hintStyle: TextStyle(color: Medicare.whiteColor),
  ...
  savingData() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('medications').add({
        ...
        'prescribedAt': Timestamp.now(), // Current timestamp
      });
