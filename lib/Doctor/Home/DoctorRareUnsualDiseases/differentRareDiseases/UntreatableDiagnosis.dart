...
class UntreatableDiagnosis extends StatefulWidget {
  UntreatableDiagnosis({super.key});
  @override
  // Creating the state for this widget.
  State<UntreatableDiagnosis> createState() => _UntreatableDiagnosisState();
}

// Private State class for handling the dynamic aspects of the UntreatableDiagnosis screen.
class _UntreatableDiagnosisState extends State<UntreatableDiagnosis> {
  final TextEditingController _chief = TextEditingController();
  final TextEditingController _symptoms = TextEditingController();
  final TextEditingController _initialDiagnosis = TextEditingController();
  ...
  Future<void> submitDisease() async {
    if (_chief.text.isEmpty ||
        ...
        _initialDiagnosis.text.isEmpty ||
  ...
  savingData() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Disease Saved successfully.'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to Save disease: $e'),
          backgroundColor: Colors.red,
        ),
      );
    }
