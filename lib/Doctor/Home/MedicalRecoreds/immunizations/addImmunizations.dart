...
class addImmunizations extends StatefulWidget {
  String patientName;
  String patientID;
  String customID;
  ...
  State<addImmunizations> createState() => _addImmunizationsState();
}

// Private State class for handling the dynamic aspects of the addImmunizations screen.
class _addImmunizationsState extends State<addImmunizations> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(
          context, "${widget.patientName.split(' ')[0]}'s Immunizations", () {
                  ...
                  Column(
                    children: [
                      Transform.translate(
                        ...
                        child: Text(
                          "Immunizations", // Heading text for the section.
                          style: TextStyle(
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Type of Vaccine', // Hint text that appears in the center.
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Vaccine Name', // Hint text that appears in the center.
                            hintStyle: const TextStyle(
                              color: Colors.grey, // Style the hint text.
                            ),
                            border: OutlineInputBorder(
  ...
  savingData() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('immunizations').add({
