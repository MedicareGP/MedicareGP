...
import 'package:medicare/Doctor/Home/MedicalRecoreds/immunizations/addImmunizations.dart';
...
class ViewImmunizations extends StatefulWidget {
  ...
  State<ViewImmunizations> createState() => _ViewImmunizationsState();
}

// Private State class for handling the dynamic aspects of the ViewImmunizations screen.
class _ViewImmunizationsState extends State<ViewImmunizations> {
  @override
  // Building the widget tree for this state.
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, "Immunizations", () {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${widget.patientName.split(' ')[0]}'s Immunizations",
