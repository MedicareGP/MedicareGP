...
class AddPhysicalExamination extends StatefulWidget {
  String patientName;
  String patientID;
  String customID;
  ...
  State<AddPhysicalExamination> createState() => _AddPhysicalExaminationState();
}

// Private State class for handling the dynamic aspects of the AddPhysicalExamination screen.
class _AddPhysicalExaminationState extends State<AddPhysicalExamination> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(
          context, "${widget.patientName.split(' ')[0]}'s Physical Examination",
          () {
                  ...
                  Column(
                    children: [
                      Transform.translate(
                        ...
                        child: Text(
                          "Physical Examination", // Heading text for the section.
                          style: TextStyle(
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Title', // Hint text that appears in the center.
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Enter Result', // Hint text that appears in the center.
                            hintStyle: const TextStyle(
                              color: Colors.grey, // Style the hint text.
                            ),
                            border: OutlineInputBorder(
  ...
  savingData() async {
    ...
    try {
      await FirebaseFirestore.instance.collection('physicalExamination').add({
