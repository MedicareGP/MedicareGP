...
// Defining a StatefulWidget to handle state changes for viewing procedures.
class ViewProcedures extends StatefulWidget {
  ...
  State<ViewProcedures> createState() => _ViewProceduresState();
}

// Private State class for handling the dynamic aspects of the ViewProcedures screen.
class _ViewProceduresState extends State<ViewProcedures> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      }), // Adding a custom app bar with the title "Procedures".
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${widget.patientName.split(' ')[0]}'s Procedures",
