...
// Private State class for handling the dynamic aspects of the ViewTests screen.
class _ViewTestsState extends State<ViewTests> {
  @override
  // Building the widget tree for this state.
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context, "Test Results", () {
                ...
                Row(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(
                          "${widget.patientName.split(' ')[0]}'s Test Results",
