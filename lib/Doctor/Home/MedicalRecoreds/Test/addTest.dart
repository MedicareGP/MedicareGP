...
// Private State class for handling the dynamic aspects of the AddTests screen.
class _AddTestsState extends State<AddTests> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(
          context, "${widget.patientName.split(' ')[0]}'s Test Results", () {
                  ...
                  Column(
                    children: [
                      Transform.translate(
                        ...
                        child: Text(
                          "Add Test Result", // Heading text for the section.
                          style: TextStyle(
                      ...
                      children: [
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Test Name', // Hint text that appears in the center.
                        ...
                        TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                'Enter Description', // Hint text that appears in the center.
                            hintStyle: const TextStyle(
                              color: Colors.grey, // Style the hint text.
                            ),
                            border: OutlineInputBorder(
                          ...
                          decoration: InputDecoration(
                            contentPadding: const EdgeInsets.symmetric(
                                vertical:
                                    8), // Reduces the vertical padding, making the field shorter.
                            hintText:
                                'Recorded By', // Hint text that appears in the center.
                            hintStyle: const TextStyle(
                              color: Colors.grey, // Style the hint text.
                            ),
                            border: OutlineInputBorder(
  ...
  savingData() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Lab result successfully saved.'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Failed to save lab result: $e'),
          backgroundColor: Colors.red,
        ),
      );
    }
